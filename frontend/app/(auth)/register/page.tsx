        ...
        <div className="relative z-10">
          ...
          <div className="mb-12">
            ...
            <p className="text-white/50 text-base leading-relaxed max-w-sm">
              Join 500+ businesses using Bolo to reach customers in their native language with AI-powered voice.
            </p>
          </div>
        ...
        <div className="relative z-10">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
            <p className="text-white/80 text-sm italic leading-relaxed mb-3">
              &ldquo;Bolo helped us reach 3x more rural customers by adding Hindi voice support to our app in a single afternoon.&rdquo;
            </p>

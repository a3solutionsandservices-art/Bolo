...
export default function BillingPage() {
  ...
  const portalMutation = useMutation({
    mutationFn: () =>
      api.billing.portal(`${window.location.origin}/settings/billing`).then((r) => r.data),
              ...
              return (
                ...
                >
                  ...
                  {plan.price_monthly ? (
                    ...
                    <a href="mailto:sales@vaaniai.com" className="block w-full py-2.5 border border-brand-600 text-brand-600 rounded-lg text-sm font-medium hover:bg-brand-50 transition-colors text-center">
                      Contact Sales
                    </a>
                  )}
                </div>

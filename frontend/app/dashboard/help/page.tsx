  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Bolo reads your documents automatically. Each file usually takes 1–2 minutes. You'll see the status change to 'Ready' when done.",
      },
      {
        emoji: "5️⃣",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The Latency chart shows how fast Bolo is responding. Under 2000ms (2 seconds) is excellent. If you see high latency, the Sarvam AI service may be under load.",
      },
    ],
  },
  {
...
const FAQS = [
  ...
  {
    q: "Which languages does Bolo support?",
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500">Step-by-step guides for getting the most out of Bolo — no technical knowledge needed.</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-brand-600 to-violet-600 rounded-2xl p-6 text-white text-center">
        ...
        <p className="text-brand-100 text-sm mb-4">
          ...
          <a href="mailto:support@bolo.com" className="underline font-medium">support@bolo.com</a>

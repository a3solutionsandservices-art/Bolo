...
const GUIDES = [
  ...
  },
  {
    ...
    steps: [
      { emoji: "🎙️", title: "Voice AI for Indian languages", body: "Bolo lets your customers speak to your business in Hindi, Tamil, Telugu, Bengali, Marathi, Gujarati, Kannada, Malayalam, Punjabi, and more — and get instant AI-powered responses in their language." },
...
const FAQS = [
  ...
  { category: "widget", q: "Which languages does Bolo support?", a: "Hindi, Tamil, Telugu, Bengali, Marathi, Gujarati, Kannada, Malayalam, and Punjabi — plus English. We also support Bhojpuri, Awadhi, and Maithili in the Voice Marketplace. You can set any combination of 'user speaks' and 'AI responds in' languages." },

  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/70 shadow-card p-6">
        ...
        <p className="text-xs text-slate-400 mb-5">Set to 0 to disable that tier. VaaniAI takes 20% — you keep 80%.</p>
        <div className="grid grid-cols-2 gap-4">
          {[
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
        ...
        <p className="text-xs text-amber-800 leading-relaxed mb-4">
          By registering, you confirm that this is your own voice, you hold all rights to it, and you agree to VaaniAI&apos;s Voice Licensing Terms. VaaniAI will verify your identity before making your profile public. Your voice will only be licensed for purposes you explicitly allow. You can revoke any licence at any time.
        </p>
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <span className="text-xs text-amber-800 font-medium">
            I confirm this is my voice, I hold all rights to it, and I consent to VaaniAI licensing it under the terms above. I understand that misrepresentation is a violation of Indian IP law.
          </span>
        </label>
      </div>
